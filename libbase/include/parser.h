...
LIBBASE_API int	C_API_FUNC load_script				(const char *file, mem_zone_ref_ptr script_vars,unsigned int opts);
...
LIBBASE_API int	C_API_FUNC resolve_script_var		(mem_zone_ref_ptr global_vars,mem_zone_ref_ptr script_proc, const char *var_path, unsigned int var_type, mem_zone_ref_ptr out_var);
