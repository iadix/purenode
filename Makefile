...
export/launcher: launcher/main.c export/libcon.so
	gcc $(CFLAGS) -L./export -lcon -lm -lpthread -Ilibcon -Ilibcon/include -Ilibbase/include launcher/main.c -o export/launcher
...
export/libcon.so: $(CONSRC) $(XMLSRC) $(ZLIBSRC)
	...
	gcc $(CFLAGS) -lm -Ilibcon -Ilibcon/zlib-1.2.8/ -Ilibcon/include -Ilibcon/unix/include -Ilibcon/expat/xmlparse -Ilibcon/expat/xmltok runtime.o tpo.o $(CONSRC) $(XMLSRC) $(ZLIBSRC) -fPIC -DIMP_API= -shared -o export/libcon.so
