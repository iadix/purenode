...
export/launcher:
	gcc $(CFLAGS) -Lexport/ -lcon -Ilibcon -Ilibcon/include -Ilibbase/include launcher/main.c -o export/launcher.exe

export/iadixcoin.so:
	gcc $(CFLAGS) -Lexport/ -lcon -Ilibcon -Ilibcon/include -Ilibbase/include iadixcoin/main.c  --shared -o export/iadixcoin.so

export/libcon.so: $(CONSRC) $(XMLSRC) $(ZLIBSRC)
	nasm -f elf32 libcon/tpo.asm -o tpo.o
	nasm -f elf32 libcon/runtime.asm -o runtime.o
	gcc $(CFLAGS) -Ilibcon -Ilibcon/include -Ilibcon/unix/include -Ilibcon/expat/xmlparse -Ilibcon/expat/xmltok runtime.o tpo.o $(CONSRC) $(XMLSRC) $(ZLIBSRC) -DIMP_API= --shared -o export/libcon.so
